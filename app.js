...
app.get('/', function(req,res) {
  texto = 'Ni Superman, Iron Man o La Mujer Maravilla son tan importantes cómo las y los Héroes de carne y hueso que encontrarás en este sitio. Esperamos que ellas y ellos te sirvan como inspiración para poder cumplir tus objetivos. Recuerda: ¡nunca pares de creer en ti!.';
  res.send(texto)
});
...
app.get('/creditos', (req,res) => {
  res.send('Juan Francisco Lukac y hoy es mi cumpleaños');
});
